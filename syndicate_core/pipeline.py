...
def game_dirs(game_key: str) -> dict:
    ...
    d = {
        ...
        "Base":            var_inputs / f"Base_{gk}",
        "Splits":          var_inputs / f"Splits_{gk}",
        "Splits_Combi":    var_inputs / f"Splits_Combi_{gk}",
        "Rainbow":         var_inputs / f"Rainbow_{gk}",
        "ExcelPro":        var_inputs / f"ExcelPro_{gk}",
